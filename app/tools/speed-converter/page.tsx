...
const units = [
  { id: 'mps', name: 'Meters/second (m/s)', factor: 1 },
  { id: 'kmh', name: 'Kilometers/hour (km/h)', factor: 0.277778 },
  { id: 'mph', name: 'Miles/hour (mph)', factor: 0.44704 },
  { id: 'fps', name: 'Feet/second (ft/s)', factor: 0.3048 },
  { id: 'knot', name: 'Knots (kn)', factor: 0.514444 },
  { id: 'mach', name: 'Mach (at sea level)', factor: 343 },
  { id: 'c', name: 'Speed of light (c)', factor: 299792458 },
];
    ...
    <ToolLayout tool={tool}>
      <section className="mb-8">
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          Convert between different <strong>speed and velocity units</strong> instantly.
          Supports km/h, mph, m/s, knots, and more for travel, sports, and science.
      ...
      <div className="mb-12 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
        ...
        <ul className="text-sm text-blue-700 dark:text-blue-400 space-y-1">
          ...
          <li>• Mach 1 (at sea level) = 1,235 km/h = 767 mph</li>
      ...
      <section className="mb-12">
        ...
        <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
          <li>Enter a speed value in the input field</li>
