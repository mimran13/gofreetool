...
const units = [
  { id: 'meter', name: 'Meters (m)', factor: 1 },
  { id: 'kilometer', name: 'Kilometers (km)', factor: 1000 },
  { id: 'centimeter', name: 'Centimeters (cm)', factor: 0.01 },
  { id: 'millimeter', name: 'Millimeters (mm)', factor: 0.001 },
  { id: 'mile', name: 'Miles (mi)', factor: 1609.344 },
  { id: 'yard', name: 'Yards (yd)', factor: 0.9144 },
  { id: 'foot', name: 'Feet (ft)', factor: 0.3048 },
  { id: 'inch', name: 'Inches (in)', factor: 0.0254 },
  { id: 'nautical-mile', name: 'Nautical Miles (nmi)', factor: 1852 },
  { id: 'micrometer', name: 'Micrometers (μm)', factor: 0.000001 },
];
    ...
    <ToolLayout tool={tool}>
      <section className="mb-8">
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
          Convert between different <strong>length and distance units</strong> instantly.
          Supports metric (meters, kilometers, centimeters) and imperial (feet, inches, miles, yards) units.
      ...
      <div className="mb-12 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
        ...
        <ul className="text-sm text-blue-700 dark:text-blue-400 space-y-1">
          ...
          <li>• 1 foot = 30.48 centimeters = 12 inches</li>
          <li>• 1 yard = 0.9144 meters = 3 feet</li>
          <li>• 1 mile = 1.609 kilometers = 5,280 feet</li>
